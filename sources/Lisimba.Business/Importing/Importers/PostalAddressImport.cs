...
namespace DustInTheWind.Lisimba.Business.Importing.Importers
{
    public class PostalAddressImport : ItemImportBase<Contact, PostalAddress>
    {
        ...
        protected override void AddAsNew(StringBuilder sb, bool simulate)
        {
            ...
            sb.AppendLine(string.Format("Added postal address: {0}", SourceValue));
        }

        protected override void Merge(StringBuilder sb, bool simulate)
        {
            sb.AppendLine(string.Format("Merging postal address '{0}' and '{1}'.", DestinationValue, SourceValue));
        ...
        protected override void Replace(StringBuilder sb, bool simulate)
        {
            ...
            sb.AppendLine(string.Format("Replaced postal address '{0}' with '{1}'.", DestinationValue, SourceValue));
        }
    }
}