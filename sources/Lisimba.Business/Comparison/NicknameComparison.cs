...
{
    public class NicknameComparison : ItemComparisonBase
    {
        public NicknameComparison(Contact contactLeft, Contact contactRight)
        ...
        {
            return ContactLeft.Name.HasNickname;
        }

        protected override bool ContactRightHasValue()
        {
            return ContactRight.Name.HasNickname;
        }
