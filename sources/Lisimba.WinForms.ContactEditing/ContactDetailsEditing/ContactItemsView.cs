...
{
    public partial class ContactItemsView : UserControl
    {
        private CustomObservableCollection<ContactItem> contactItems;
        private List<ContactItemSet> sets;

        private List<ContactItemSetView> setViews;
        private List<ContactItemSetViewModel> setViewModels;
        ...
        private static ContactItemSetViewModel CreateSetViewModel(ContactItemSet set)
        {
            return new ContactItemSetViewModel
            {
                Image = set.Icon,
        ...
        private static ContactItemSetView CreateSetView(ContactItemSetViewModel setViewModel, int index)
        {
            return new ContactItemSetView
            {
                Dock = DockStyle.Fill,
                TabIndex = index,
        ...
        private void DisplayContactItems()
        {
            ...
            foreach (ContactItem contactItem in contactItems)
            {
                ...
                ContactItemSetViewModel setViewModel = setViewModels[setIndex];
