...
{
    internal class SaveAddressBookOperation : OperationBase<object>
    {
        ...
        public SaveAddressBookOperation(AddressBooks addressBooks, WindowSystem windowSystem)
            : base(windowSystem)
        {
        ...
        {
            addressBooks.SaveCurrentAddressBook();
        }
    }
}