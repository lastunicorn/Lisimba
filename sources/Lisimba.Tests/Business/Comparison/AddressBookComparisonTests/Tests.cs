...
namespace DustInTheWind.Lisimba.Tests.Business.Comparison.AddressBookComparisonTests
{
    ...
    public class Tests
    {
        ...
        {
            AddressBookComparison addressBookComparison = new AddressBookComparison(addressBook1, addressBook2);
            addressBookComparison.Compare();

            Assert.That(addressBookComparison.IdenticalContacts.Count(), Is.EqualTo(0));
            Assert.That(addressBookComparison.UniqueLeftContacts.Count(), Is.EqualTo(0));
            Assert.That(addressBookComparison.UniqueRightContacts.Count(), Is.EqualTo(0));
        }
        ...
        public void comparing_address_books_with_one_identical_contact()
        {
            ...
            Assert.That(addressBookComparison.IdenticalContacts.Count(), Is.EqualTo(1));
            Assert.That(addressBookComparison.UniqueLeftContacts.Count(), Is.EqualTo(0));
            Assert.That(addressBookComparison.UniqueRightContacts.Count(), Is.EqualTo(0));
        }
        ...
        public void address_book_1_has_one_contact_address_book_2_has_no_contact()
        {
            ...
            Assert.That(addressBookComparison.IdenticalContacts.Count(), Is.EqualTo(0));
            Assert.That(addressBookComparison.UniqueLeftContacts.Count(), Is.EqualTo(1));
            Assert.That(addressBookComparison.UniqueRightContacts.Count(), Is.EqualTo(0));
        }
        ...
        public void address_book_1_has_no_contact_address_book_2_has_one_contact()
        {
            ...
            Assert.That(addressBookComparison.IdenticalContacts.Count(), Is.EqualTo(0));
            Assert.That(addressBookComparison.UniqueLeftContacts.Count(), Is.EqualTo(0));
            Assert.That(addressBookComparison.UniqueRightContacts.Count(), Is.EqualTo(1));
        }
