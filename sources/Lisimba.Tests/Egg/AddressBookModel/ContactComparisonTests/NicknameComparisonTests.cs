...
namespace DustInTheWind.Lisimba.Tests.Egg.AddressBookModel.ContactComparisonTests
{
    ...
    {
        [Test]
        public void after_Compare_the_Differences_contains_the_NicknameComparison()
        {
        ...
        {
            NicknameComparison nicknameComparison = comparisons.OfType<NicknameComparison>().First();
            Assert.That(nicknameComparison.Equality, Is.EqualTo(expectedEquality));
        }
