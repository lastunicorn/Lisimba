...
namespace DustInTheWind.Lisimba.Tests.Egg.AddressBookModel.ContactComparisonTests
{
    ...
    public class CategoryComparisonTests
    {
        ...
        public void after_Compare_the_Differences_contains_the_CategoryComparison()
        {
            ...
            AssertContainsType(contactComparison.Differences, typeof(CategoryComparison));
        }
        ...
        {
            CategoryComparison categoryComparison = comparisons.OfType<CategoryComparison>().First();
            Assert.That(categoryComparison.Equality, Is.EqualTo(expectedEquality));
        }
